...
<body id="body" data-spy="scroll" data-target=".navbar" data-offset="100">
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse navbar-menu-wrapper" id="navbarSupportedContent">
        <ul class="navbar-nav align-items-lg-center align-items-start ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="#digital-marketing-section">Product</a>  
          </li>
          <li class="nav-item">
  ...
  <div class="banner" >
    <div class="container">
      <h1 class="font-weight-semibold">Demo Website</h1>
      <h6 class="font-weight-normal text-muted pb-3">Lorem ipsum dolor sit amet consectetur adipisicing elit. Cum iusto praesentium modi alias. Voluptatum, nostrum?</h6>
      <div>
    ...
    <div class="container">
      <section class="features-overview" id="features-section" >
        <div class="content-header">
          ...
          <h6 class="section-subtitle text-muted">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Distinctio, tenetur!<br>Lorem ipsum dolor sit amet.</h6>
        </div>
        <div class="d-md-flex justify-content-between">
          <div class="grid-margin d-flex justify-content-start">
            <div class="features-width">
              <img src="images/Group12.svg" alt="" class="img-icons">
              <h5 class="py-3">Pelayanan<br>Cepat</h5>
              <p class="text-muted">Lorem ipsum dolor sit amet, tincidunt vestibulum. Fusce egeabus consectetuer turpis, suspendisse.</p>
              <a href="#"><p class="readmore-link">Baca Selengkapnya</p></a>  
            </div>
          </div>
          <div class="grid-margin d-flex justify-content-center">
            <div class="features-width">
              <img src="images/Group7.svg" alt="" class="img-icons">
              <h5 class="py-3">Kebutuhan</h5>
              <p class="text-muted">Lorem ipsum dolor sit amet, tincidunt vestibulum. Fusce egeabus consectetuer turpis, suspendisse.</p>
              <a href="#"><p class="readmore-link">Baca Selengkapnya</p></a>
            </div>
          </div>
          <div class="grid-margin d-flex justify-content-end">
            <div class="features-width">
              ...
              <h5 class="py-3">Jangka Panjang</h5>
              <p class="text-muted">Lorem ipsum dolor sit amet, tincidunt vestibulum. Fusce egeabus consectetuer turpis, suspendisse.</p>
              <a href="#"><p class="readmore-link">Baca Selengkapnya</p></a>
            </div>
          </div>
      ...
      <section class="digital-marketing-service" id="digital-marketing-section">
        <div class="row align-items-center">
          <div class="col-12 col-lg-7 grid-margin grid-margin-lg-0" data-aos="fade-right">
            <h3 class="m-0">Demo Website<br>Inspirasikan Teks</h3>
        ...
        <div class="row align-items-center">
          ...
          <div class="col-12 col-lg-5 flex-item grid-margin" data-aos="fade-left">
            ...
            <button class="btn btn-info"><a href="http://wa.me/62895395850837" target="_blank" rel="noopener noreferrer">Segera Hubungi Kami</a></button>
          </div>
        </div>
      </section>     
      ...
      <section class="contact-us" id="contact-section">
        <div class="contact-us-bgimage grid-margin" >
          <div class="pb-4">
            <h4 class="px-3 px-md-0 m-0" data-aos="fade-down">Punya sebuah projek?</h4>
            <h4 class="pt-1" data-aos="fade-down">Hubungi Kami Dibawah</h4>
          </div>
          <div data-aos="fade-up">
            <button class="btn btn-rounded btn-outline-danger">Kontak Kami</button>
          </div>          
        </div>
      </section>
      <section class="contact-details" id="contact-details-section">
        <div class="row text-center text-md-left">
          <div class="col-12 col-md-6 col-lg-3 grid-margin">
            ...
            <div class="pt-2">
              <p class="text-muted m-0">ramz@gmail.com</p>
              <p class="text-muted m-0">0895395850837</p>
            </div>         
          </div>
          <div class="col-12 col-md-6 col-lg-3 grid-margin">
            <h5 class="pb-2">Demo Website</h5>
            <p class="text-muted">Don’t miss any updates of our new templates and extensions.!</p>
            <form>
              <input type="text" class="form-control" id="Email" placeholder="Email id">
            </form>
            <div class="pt-3">
              <button class="btn btn-dark">Langganan</button>
            </div>   
          </div>
          <div class="col-12 col-md-6 col-lg-3 grid-margin">
            <h5 class="pb-2">Demo Website</h5>
          ...
          <div class="col-12 col-md-6 col-lg-3 grid-margin">
              <h5 class="pb-2">Demo Website</h5>
              <p class="text-muted">Ramz<br>Five jacks</p>
      ...
      <footer class="border-top">
        <p class="text-center text-muted pt-4">Copyright © 2024<a href="https://www.bootstrapdash.com/" class="px-1">Ramz.</a>All rights reserved.</p>

        <p class="text-center text-muted pt-2">Distributed and Special Thanks To: <a href="https://www.themewagon.com/" class="px-1" target="_blank">Bootstrap</a></p>
      </footer>
